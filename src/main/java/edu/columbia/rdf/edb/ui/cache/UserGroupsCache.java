...
/**
 * Cache the groups a user belongs to.
 * 
 * @author antony
 *
 */
public class UserGroupsCache extends EntityCache<Group> {
  
  /** The m login. */
  private EDBWLogin mLogin;

  /**
   * Instantiates a new user groups cache.
   *
   * @param login the login
   */
  public UserGroupsCache(EDBWLogin login) {
    mLogin = login;
  }
  ...
  public void cache() throws IOException {
    ...
    URL url = mLogin.getURL().join("account").join("groups").toURL();
