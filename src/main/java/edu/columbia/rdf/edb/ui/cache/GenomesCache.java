 ...
 *
 */
public class GenomesCache extends EntityCache<Genome> {
  ...
  public void cache() throws IOException {
    ...
    for (int i = 0; i < json.size(); ++i) {
      ...
      String name = sectionTypeJSON.get(EDB.HEADING_NAME).getString();
      
      put(id, new Genome(id, name));
    }
  }
}
